...
# 考察・まとめ
ルートを動画や地図にして視覚化することで、地震時にドローンを飛ばす際にどこを飛ばすべきか事前に把握することができ、迷いなく飛ばせるので迅速な情報収集が出来ることが分かる。さらにgeojson.io上で効率的なルートを作成することでさらに素早い対応になることも期待できる。また、Google Earth Studioで高度150ｍの高さで飛ばそうとした場合、ビルに衝突する可能性も確認できたので、事故の防止にも繋がる。これらのことから事前にシミュレーション動画を作成するこの研究を通して、実際の地震同様の動きを明確に想定でき、対策を練ることが出来ると分かった。
次に引き継ぐべき課題とは、その土地をよく知らないと、どの場所を飛ばしているのか上空から見ただけでは飛ばしたい場所の見分けがつかないので、緯度経度などの具体的な数値を取り入れた地図の作成をすべきだと考える。
